-- Add a new superhero
INSERT INTO superhero (id, superhero_name, full_name, publisher_id, height_cm, weight_kg)
VALUES (6001, 'Iron Man', 'Tony Stark', 13, 180, 75);
...
select * from superhero where id = 6002;
...
INSERT INTO superhero (id, superhero_name, full_name, publisher_id, height_cm, weight_kg)
VALUES (6002, 'Black Widow', 'Natasha Romanoff', 13, 170, 60);
...
INSERT INTO superhero (id, superhero_name, full_name, publisher_id, height_cm, weight_kg)
VALUES (6007, 'Hulk', 'Bruce Banner', 13, 210, 120);
...
BEGIN
    ...
    INSERT INTO superhero (id, superhero_name, full_name, publisher_id, height_cm, weight_kg)
    VALUES (@p_id, 'Hulk', 'Bruce Banner', 13, 210, 120);

    -- Second Insert with hardcoded values for Iron Man
    INSERT INTO superhero (id, superhero_name, full_name, publisher_id, height_cm, weight_kg)
    VALUES (@p_id+1, 'Iron Man', 'Tony Stark', 13, 180, 75);
...
select * from superhero where id = 6010
...
create table STT (id int , tsql varchar(max), ExceStatus int );
INSERT INTO STT (id,tsql,ExceStatus) VALUES 
(1,'BEGIN TRANSACTION;
    DELETE FROM superhero WHERE id = @p_id ;
    DELETE FROM superhero WHERE id = @p_id + 1;
    COMMIT;',0);