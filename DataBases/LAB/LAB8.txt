...
GO
INSERT INTO StudentCourses (StdSSN, StdCity, StdClass, OfferNo, OffTerm, OffYear, EnrGrade, CourseNo, CrsDesc) VALUES
...
INSERT INTO Studentinfo (StdSSN, StdCity) VALUES
('S1', 'SEATTLE'),
('S2', 'BOTHELL');
-- Insert into OfferNoDependents 
INSERT INTO OfferNoDependents (OfferNo, OffTerm, OffYear, CourseNo, CrsDesc) VALUES
('O1', 'FALL', 2006, 'C1', 'DB'),
('O2', 'FALL', 2006, 'C2', 'VB'),
...
GO
INSERT INTO COURSE (CourseNo, CrsDesc) VALUES
( 'C1', 'DB'),
( 'C2', 'VB'),
( 'C3', 'OO');
GO 
